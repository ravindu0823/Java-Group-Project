...
function updateSelectedCount() {
  ...
  total.textContent = selectedSeatsCount * ticketPrice * 30;

  var item = localStorage.getItem("selectedSeats");
  item = item.substring(1, item.length - 1);

  document.getElementById("temp").value = item;
  document.getElementById("seat_count").value = count.textContent;
  document.getElementById("total_price").value = total.textContent;
}
